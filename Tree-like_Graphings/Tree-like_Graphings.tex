...
\begin{document}
    ...
    \begin{example}
        For a locally finite graph $(X,G)$, the cuts $\mc{H}_{\diam(\del)\leq R}(X)$ studied in Section \ref{sec:dense_cuts_induced_by_quasi-trees} is finitely-separating for any $R<\infty$. Indeed, 
    \end{example}
