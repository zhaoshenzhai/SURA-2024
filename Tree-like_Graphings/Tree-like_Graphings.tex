...
\begin{document}
    ...
    We identify $X\into\widehat{X}$ via principal ultrafilter map $x\mapsto p_x$. By definition, $\widehat{X}$ admits a basis of clopen sets of the form $\widehat{A}$ for $A\in\mc{H}_{\del<\infty}(X)$, consisting of those ultrafilters containing $A$. Note that $A\subseteq B$ iff $\widehat{A}\subseteq\widehat{B}$.
