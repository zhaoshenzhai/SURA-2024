...
\begin{document}
    ...
    \begin{example}
        For the subpocset $\mc{H}_{\diam(\del)\leq R}(X)\subseteq\mc{H}_{\del<\infty}(X)$ of cuts in a connected locally-finite graph $(X,G)$ studied in Section \ref{sec:dense_cuts_induced_by_quasi-trees}
    \end{example}
