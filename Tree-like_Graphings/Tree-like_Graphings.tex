...
\begin{document}
    ...
    Let $(X,G)$ be a connected locally-finite graph and consider a family $\mc{H}\subseteq\mc{H}_{\del<\infty}$ of cuts that are dense towards ends of $G$.
