...
\begin{document}
    ...
    \begin{lemma}
        The pocset $2^X$ equipped with the product topology of the discrete space $2\coloneqq\l\{0,1\r\}$ is profinite, and admits a basis of `cylinders': for each finite $A\subseteq X$ and $W\in2^A$, the {\rm{cylinder}} at $W$ is
        \begin{equation*}
