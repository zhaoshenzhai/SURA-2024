...
\begin{document}
    ...
    Let $(X,G)$ be a connected locally-finite graph and fix a pocset $\mc{H}$ of cuts. This section investigates certain finiteness conditions on $\mc{H}$ when it is dense towards ends, which ultimately is only needed to set up a Borel bireduction \TODO[what is this...]
    ...
    \end{proposition}
    \begin{proof}
        \TODO[define $\mc{H}$-blocks and successors beforehand too.]
    \end{proof}
