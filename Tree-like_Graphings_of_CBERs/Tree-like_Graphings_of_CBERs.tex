...
\begin{document}
    ...
    \begin{appendices}
        ...
        \begin{example}
            For $A\coloneqq\l\{a,b\r\}$, we have $\proj_A(x)=\l\langle a,b,x\r\rangle$ since $\l\langle a,b,x\r\rangle\in[x,a]\cap[x,b]$ is the unique such point in $\cvx(A)=[a,b]$.
        \end{example}
