...
\begin{document}
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            \item[2.] Fix $H\in\mc{H}^\ast$ and let $K_\alpha\in\mc{H}^\ast$ be the successors of $H$. If $p\in\epsilon(\lnot H)$ is an end in $\lnot H$, then, since $\mc{H}$ is dense towards ends, there is some $H'\subseteq\lnot H$ containing $p$
        \end{enumerate}
