...
\begin{document}
    ...
    \begin{mainTheorem}\label{thm:component-wise_construction}
        ...
        If $(X,G)$ is a connected locally-finite graph, then there is a family $\mc{H}\subseteq2^X$ of finitely-separating cuts whose dual median graph $\mc{M}(\mc{H})$ admits a canonical spanning trees.
    \end{mainTheorem}
