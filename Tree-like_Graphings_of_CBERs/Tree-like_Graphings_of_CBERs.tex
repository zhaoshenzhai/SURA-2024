...
\begin{document}
    ...
    This lemma will be our main method for identifying finitely-separating pocsets. In the special case of cuts $\mc{H}\subseteq\mc{H}_{\del<\infty}\cap\mc{H}_\mathrm{conn}$, finite-separation also controls the degree of `non-nestedness' of said cuts.
    ...
    \begin{lemma}\label{lem:connected_cuts_non_nested_finitely_others}
        If a family $\mc{H}\subseteq\mc{H}_{\del<\infty}\cap\mc{H}_\mathrm{conn}$ of cuts is finitely-separating, then each $H\in\mc{H}$ is non-nested with finitely-many others.
    \end{lemma}
    \begin{proof}
