...
\begin{document}
    ...
    \begin{proof}
        That $\mc{H}$ is finitely-separating follows from Example \ref{exa:finitely_separating_iff_on_boundary_of_finite} and Proposition \ref{prp:half-spaces_are_cones}.
    \end{proof}
