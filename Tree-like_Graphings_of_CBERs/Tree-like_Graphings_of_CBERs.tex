...
\begin{document}
    ...
    Finally, for this to apply to the dual median graph $\mc{M}(\mc{H})$ of a finitely-separating family of cuts $\mc{H}$ on a connected locally-finite graph, and to prove Theorem \ref{thm:component-wise_construction}, we need the following
