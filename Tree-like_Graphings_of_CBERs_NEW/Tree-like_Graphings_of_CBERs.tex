...
\begin{document}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \draw[->] (\hsp+1.1,\vsh) -- (3*\hsp-1.1,\vsh) node[midway, above=-2pt]{\tiny{Sec.\!\! \ref{sec:finiteness_conditions_on_pocsets_dense_cuts}+{\color{red}3.?} (finiteness conditions)}};
    ...
    \section{Borel Subtreeing of Quasi-treeings}\label{sec:borel_subtreeing_of_quasi-treeings}
