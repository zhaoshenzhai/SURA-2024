...
\begin{document}
    ...
    The construction starts by identifying a profinite pocset $\mc{H}$ of `cuts' in the graph, which we first study abstractly.
    ...
    If $\mc{H}\subseteq\mc{H}_{\del<\infty}\cap\mc{H}_\textrm{conn}$ is a pocset of cuts with every non-trivial element isolated, 
