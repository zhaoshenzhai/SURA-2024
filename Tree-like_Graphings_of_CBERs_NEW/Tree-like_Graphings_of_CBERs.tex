...
\begin{document}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \draw[->] (1.1,\vsh-\vsp) -- (\hsp-1.1,\vsh-\vsp) node[midway, above=-2pt]{\tiny{Sec.\!\! {\color{red}??}}};
    ...
    \section{Dense cuts induced by quasi-trees}\label{sec:dense_cuts_induced_by_quasi-trees}

    Let $(X,G)$ be a connected locally-finite quasi-tree, which, in the context of Theorem \ref{thm:treeing_quasi-trees}, stands for a single component of the locally-finite graphing of the CBER.
    ...
    \subsection{A family of finitely-separating cuts}
