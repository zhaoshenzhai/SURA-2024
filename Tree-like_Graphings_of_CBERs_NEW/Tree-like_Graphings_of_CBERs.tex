...
\begin{document}
    ...
    \begin{mainTheorem}\label{thm:component-wise_construction}
        If $\mc{H}\subseteq2^X$ is a collection of finitely-separating cuts on a connected locally-finite graph $(X,G)$, then the median graph $\mc{M}(\mc{H})$ admits a canonical spanning tree.
    \end{mainTheorem}
