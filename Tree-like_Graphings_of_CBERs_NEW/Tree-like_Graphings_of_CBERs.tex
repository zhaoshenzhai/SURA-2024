...
\begin{document}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \draw (\hsp,-0.6) circle (0in) node[rotate=90]{$=$};
    ...
    \section{The Main Constructions}\label{sec:the_main_constructions}
